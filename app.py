...
def displayform():
    if option == 'Basic':
        ...
        if submitted:
            ...
            hair_growth,skin_darkening,hair_loss,pimples,fast_food,reg_exercise,pulse_rate,rr,pregnant])
    else:
        ...
        if submitted:
            displayresult(1,[age,weight,height,bmi,pulse_rate,rr,hb,cycle_len,pregnant,beta_hcg,fsh,lh,fsh_lh,hip,waist,waist_hip_ratio,
            tsh,prl,vit_d3,prg,rbs,weight_gain,hair_growth,skin_darkening,hair_loss,pimples,fast_food,reg_exercise,
            bp_systolic,bp_diastolic,follicle_no_l,follicle_no_r,avg_f_size_l,avg_f_size_r,endometrium])
...
def displayresult(n,data):
    ...
    if pred[0] == 1.0:
        ...
        st.write("You have PCOS")
    else:
        st.write("Prediction: False")
        st.write("You don't have PCOS")
displayform()